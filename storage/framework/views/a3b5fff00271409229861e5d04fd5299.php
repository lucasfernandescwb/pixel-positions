...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.employer-logo','data' => ['employer' => $work->employer]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['employer' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($work->employer)]); ?>
...
<?php endif; ?>
    ...
    <div class="flex-1 flex flex-col">
        <a href="#" class="self-start text-sm text-gray-400"><?php echo e($work->employer->name); ?></a>
        
        <a href="<?php echo e($work->url); ?>" target="_blank" class="font-bold text-xl mt-3 group-hover:text-blue-600 transition-colors duration-300"><?php echo e($work->title); ?></a>
        <p class="text-sm text-gray mt-auto"><?php echo e($work->schedule); ?> - From <?php echo e($work->salary); ?></p>
    </div>
...
<?php endif; ?><?php /**PATH C:\Users\xroso\Herd\pixel-positions\resources\views/components/job-card-wide.blade.php ENDPATH**/ ?>