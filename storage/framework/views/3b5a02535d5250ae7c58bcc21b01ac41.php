...
<?php
    $defaults = [
        ...
        'id' => $name,
        'name' => $name,
        'class' => 'rounded-xl bg-white/10 border border-white/10 px-5 py-4 w-full transition-colors duration-300 hover:border-blue-600/50',
        'value' => old($name),
        'autocomplete' => 'off'
    ];
?>
...
<?php /**PATH C:\Users\xroso\Herd\pixel-positions\resources\views/components/forms/input.blade.php ENDPATH**/ ?>